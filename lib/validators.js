...
var Validators = {
    ...
    matchProperty: function (propertyKey, customErrorMessage) {
        ...
        return function matchPropertyValidator(value, label, formModel, additionalVars) {
            // Check
            if (value === '' || validator.equals(value, formModel.get(propertyKey))) {
                // Valid -> All Good
                return true;
            } else if (customErrorMessage) {
                // Invalid, Custom Error Message
     ...
     * @return {Function}
     */
    isInt: function (customErrorMessage) {
        // Return Equal To Property Validation Function
     ...
     * @return {Function}
     */
    isFloat: function (customErrorMessage) {
        // Return Equal To Property Validation Function
...
// File Validators
Validators.File = require('./validators/file')(internals, validator);
