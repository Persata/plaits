...
/**
 * Compiled Error Templates For Lodash
 * @type {{}}
 */
var compiledErrorTemplates = {};
...
var internals = {
    ...
    parseErrorMessage: function (errorMessage, fields) {
        ...
        if (!compiledErrorTemplates[errorMessage]) {
            // Compile & Store
            compiledErrorTemplates[errorMessage] = _.template(errorMessage, fields);
        }
        // Run Template Function
        return compiledErrorTemplates[errorMessage](fields);
    },
